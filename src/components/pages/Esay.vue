<<<<<<< HEAD
<template lang="pug">
  section.container.mt-10
    h2.text-center.text-ro-dark 四步驟 輕鬆遊玩
    .row.mt-5.esay-section.text-ro-light
      .col-md-12
        .row.easy-point
          .col-md-6.d-flex.justify-content-center.align-items-center.flex-column.px-10
            div
              h5 步驟一、買裝只是開始
              p
                | 透過買裝備、卡片只是一個開始，
      ...
      .col-md-12
        .row.easy-point.flex-row-reverse
          .col-md-6.d-flex.justify-content-center.align-items-center.flex-column.px-10
            div
              h5 步驟二、隊友交流
              p
      ...
      .col-md-12
        .row.flex-row-reverse.easy-point
          .col-md-6.d-flex.justify-content-center.align-items-center.flex-column.px-10
            div
              h5 步驟四、最簡易影音教學
              p
...
<template>
  <section class="container mt-10">
    <h2 class="text-center text-ro-dark">四步驟 輕鬆遊玩</h2>
    <div class="row mt-5 esay-section text-ro-light">
      <div class="col-md-12">
        <div class="row easy-point">
          <div class="col-md-6 d-flex justify-content-center align-items-center flex-column px-10">
            <div>
              <h5>步驟一、買裝只是開始</h5>
              <p>透過買裝備、卡片只是一個開始，
                但是購買後絕對讓你超乎想像的打怪更輕鬆更愉悅，
      ...
      <div class="col-md-12">
        <div class="row easy-point flex-row-reverse">
          <div class="col-md-6 d-flex justify-content-center align-items-center flex-column px-10">
            <div>
              <h5>步驟二、隊友交流</h5>
              <p>
                ...
                時常有些任務必須多人組隊才可以執行，
                透過RagnarokShop所媒合的隊友，可以讓你隨時隨地立即性找尋隊友，
                <span class="text-ro-dark font-weight-bold">
                  其中也會提供隊友評價指數，
                  確保您不遇到雷雷好朋友導致玩到爆氣
                </span>。
              </p>
      ...
      <div class="col-md-12">
        <div class="row flex-row-reverse easy-point">
          <div class="col-md-6 d-flex justify-content-center align-items-center flex-column px-10">
            <div>
              <h5>步驟四、最簡易影音教學</h5>
              <p>
...
.esay-section::before {
  ...
  bottom: 0;
  left: 50%;
  border-left: 3px solid $easy-color;
